...
--------- ICONBAR ---------
	...
	s.nowplaying = _uses(s.window, {
		...
		npratinggroup = {
			...
			ratingLevel1	= {	w			 = 105,
								img			 = _loadImage(self, "NowPlaying/stars_1.png")},
			ratingLevel2	= {	w			 = 105,
								img			 = _loadImage(self, "NowPlaying/stars_2.png")},
			ratingLevel3	= {	w			 = 105,
								img			 = _loadImage(self, "NowPlaying/stars_3.png")},
			ratingLevel4	= {	w			 = 105,
								img			 = _loadImage(self, "NowPlaying/stars_4.png")},
			ratingLevel5	= {	w			 = 105,
								img			 = _loadImage(self, "NowPlaying/stars_5.png")},
		},
		npartistalbum = {
			hidden = 1,
		},
