...
function skin(self, s, reload, useDefaultSize)
	...
	s.nowplaying = _uses(s.window, {
		...
		npratinggroup = {
			...
			ratingLevel1	= {	w			 = 105,
								padding = { 40, 0, 0, 0 },
								img = Tile:loadImage(imgpath .. "NowPlaying/stars_1.png")},
			ratingLevel2	= {	w			 = 105,
								padding = { 30, 0, 0, 0 },
								img = Tile:loadImage(imgpath .. "NowPlaying/stars_2.png")},
			ratingLevel3	= {	w			 = 105,
								padding = { 20, 0, 0, 0 },
								img = Tile:loadImage(imgpath .. "NowPlaying/stars_3.png")},
			ratingLevel4	= {	w			 = 105,
								padding = { 10, 0, 0, 0 },
								img = Tile:loadImage(imgpath .. "NowPlaying/stars_4.png")},
			ratingLevel5	= {	w			 = 105,
								img = Tile:loadImage(imgpath .. "NowPlaying/stars_5.png")},
		},
	...
	s.nowplaying_small_art = _uses(s.nowplaying, {
		...
		npratinggroup = {
			...
			ratingLevel1	= {	w			 = 18,
								padding = { 0, 40, 0, 0 },
								img = Tile:loadImage(imgpath .. "NowPlaying/stars_1_vertical.png")},
			ratingLevel2	= {	w			 = 18,
								padding = { 0, 30, 0, 0 },
								img = Tile:loadImage(imgpath .. "NowPlaying/stars_2_vertical.png")},
			ratingLevel3	= {	w			 = 18,
								padding = { 0, 20, 0, 0 },
								img = Tile:loadImage(imgpath .. "NowPlaying/stars_3_vertical.png")},
			ratingLevel4	= {	w			 = 18,
								padding = { 0, 10, 0, 0 },
								img = Tile:loadImage(imgpath .. "NowPlaying/stars_4_vertical.png")},
			ratingLevel5	= {	w			 = 18,
								img = Tile:loadImage(imgpath .. "NowPlaying/stars_5_vertical.png")},
		},
	})
